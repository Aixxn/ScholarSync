...
public class MyFrame extends JFrame {
    ...
    public MyFrame(User loggedInUser) {
        ...
        logoutButton.setBounds(50, 350, 200, 35);
        ...
        editProfileButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(MyFrame.this, "Profile Editing Screen - Under Construction");
            }
        });
        ...
        logoutButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Action to logout the user and redirect to the login screen
                JOptionPane.showMessageDialog(MyFrame.this, "You have been logged out!");
                dispose();  // Close the dashboard window
                new login(); // Open the login screen again
            }
        });
