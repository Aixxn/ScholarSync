...
public class dashboard extends JFrame {
    ...
    private JPanel createStatsSection() {
        ...
        String[][] stats = {
            {"Applied Scholarships", "5", "Total scholarships you've applied to"},
            {"Pending Applications", "3", "Applications awaiting review"},
            {"Approved Applications", "2", "Successfully approved applications"}
        };
